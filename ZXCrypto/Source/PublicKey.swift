...
public class PublicKey: Key {
    ...
    public func pemString() throws -> String {
        ...
        let pem = CryptoRSA.format(keyData: data, withPemType: "RSA PUBLIC KEY")
        return pem
    }
...
//            throw CryptoRSAError.notAPublicKey
    ...
    /// This method throws if CryptoRSA cannot extract data from the key.
    ///
    ...
    required public init(data: Data) throws {
        ...
        reference = try CryptoRSA.addKey(dataWithoutHeader, isPublic: true, tag: tag)
    }
